...
//		m_canvasPanel.setBorder(new TitledBorder("sdf"));
	...
	private void addRightPanel() {
		...
		m_gamerCrhallenger = new ImageButton("image/user2.png", "user2");
		m_exitButton = new ImageButton("image/exitButton.png", "EXIT GAME", "image/exitButtonOver.png");
		...
		m_exitButton.setBounds(5, 544, 210, 44);
...
//						repaint();
		...
		private void imageLoad() {
			image = toolkit.createImage(URLGetter.getResource("image/badook_board.png"));
		}
