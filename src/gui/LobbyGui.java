...
public class LobbyGui extends JPanel implements LobbyGuiInter, PanelInterface{
	...
	private ImageButton m_sendButton = new ImageButton("image/lobbySendButton.png", "SEND","image/lobbySendButtonOver.png");
	...
	private ImageButton m_exitButton = new ImageButton("image/lobbyExitButton.png", "EXIT","image/lobbyExitButtonOver.png");
	...
	public void paint(Graphics g) {
		ImageIcon icon = new ImageIcon(
				URLGetter.getResource("image/lobbyBg.png"));
	...
	private JPanel generatorRoomListPanel() {
		m_createRoomButton = new ImageButton("image/makeRoomButton.png", "Create Game Room","image/makeRoomButtonOver.png");
		m_enterRoomButton = new ImageButton("image/enterRoomButton.png", "Enter Game Room","image/enterRoomButtonOver.png");
...
//		m_scPaneUserList.setBorder(new TitledBorder("User List"));
		m_scPaneUserList.setBounds(5, 5, 150, 200);
